  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 text-sm  '>
      ...
      <div className='mt-10'>
        {
          isEdit
          ? <button className='border border-indigo-600 px-8 py-2 rounded-full hover:bg-indigo-600 hover:text-white transition-all duration-500' onClick={() => setIsEdit(false)}>Save information</button>
